function CrossLines() {
  return (
    <>
      {/* Lines */}
      <div className="absolute left-0 right-0  top-[20px] z-10 h-px w-full dark:bg-zinc-600 bg-neutral-300 md:top-[48px]"></div>
      <div className="absolute bottom-0 right-[20px] top-0 z-10 h-full w-px dark:bg-zinc-600 bg-neutral-300 md:right-[48px]"></div>
      <div className="absolute bottom-[20px] left-0 right-0 z-10 h-px w-full dark:bg-zinc-600 bg-neutral-300 md:bottom-[48px]"></div>
      <div className="absolute bottom-0 left-[20px] top-0 z-10 h-full w-px dark:bg-zinc-600 bg-neutral-300 md:left-[48px]"></div>
