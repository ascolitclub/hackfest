    ...
    <footer id="footer" className="relative py-16 md:py-16">
      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
          ...
          >
            ...
            >
              <path
                fill="currentColor"
                d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.205 11.385.6.11.82-.26.82-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.09-.744.083-.729.083-.729 1.205.085 1.838 1.237 1.838 1.237 1.07 1.835 2.807 1.305 3.492.997.108-.775.418-1.305.762-1.605-2.665-.303-5.467-1.332-5.467-5.932 0-1.31.468-2.38 1.235-3.22-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.3 1.23a11.51 11.51 0 0 1 3-.403c1.02.004 2.046.138 3 .403 2.29-1.552 3.296-1.23 3.296-1.23.654 1.652.243 2.873.12 3.176.77.84 1.234 1.91 1.234 3.22 0 4.61-2.807 5.625-5.48 5.922.43.37.823 1.096.823 2.21v3.277c0 .32.218.694.825.576C20.565 21.795 24 17.295 24 12c0-6.63-5.37-12-12-12z"
              />
            </svg>
          </a>
        </div>
        ...
        <span className="text-muted-foreground block text-center text-sm">
          {" "}
          © {new Date().getFullYear()} ASCOL_HACKFEST, All rights reserved
        </span>
      </div>
    </footer>
  );
